...
**App version:** 1.6.20 · validated against **PDC 10.2.11**
...
- **`courseware/Glossary-Generator-1_6_20.pptx`** — the session deck (original slides + a five-slide
  architecture reference).
- **`courseware/Workshop-Glossary-Generator-1_6_20.docx`** — the standalone guide: opens with the
...
- **`water_utility.people.json`** — the AWC people/steward roster seed (owners of glossary terms).
