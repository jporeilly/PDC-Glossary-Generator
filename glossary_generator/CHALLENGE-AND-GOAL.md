...
![The challenge and the goal](diagrams/challenge-and-goal.png)
...
(phone, customer id, meter reading, water-quality result, …). Each row is the
...
![Two apps, one registry](diagrams/two-apps.png)
